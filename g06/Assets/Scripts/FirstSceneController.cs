...
public class FirstSceneController : MonoBehaviour, IUserAction, ISceneController
{
    ...
    public ArrowActionManager action_manager;                     //动作管理
    ...
    void Start ()
    {
        ...
        action_manager = gameObject.AddComponent<ArrowActionManager>() as ArrowActionManager;
        LoadResources();
    ...
    {
        bow = Instantiate(Resources.Load("Free medieval weapons/Prefabs/Bow", typeof(GameObject))) as GameObject;
