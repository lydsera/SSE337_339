...
namespace PriestAndDevil
{
    ...
    public class Role
    {
        ...
        public GameObject GetRole(){return role;}
    ...
    public class Boat
    {
        ...
        public Vector3 GetTargetPos()
        {
            ...
            {
                boat_flag = 1;
                return new Vector3(5.09F, 0.25F, -0.44F);
            }
            else
            {
                boat_flag = -1;
        ...
        public void Reset()
        {
            if (boat_flag == -1)
                boat_flag = -boat_flag;
            boat.transform.position = new Vector3(5.09F, 0.25F, -0.44F);
            roles = new Role[2];
        }
    ...
    public class Judge
    {
        ...
        public int Check()
        {
            Side left_side = controller.left_side;
            Side right_side = controller.right_side;
